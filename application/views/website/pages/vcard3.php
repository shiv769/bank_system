...
<body>
	...
	<section class="comp" id="home">
      ...
      <div class="vcard1">
          ...
          <h3 style="margin-top: 70px;font-size: 18px;color: #ea1e63;width: 250px;height:50px;"> <?= $tempdata['c_name']; ?> </h3>
          ...
          <div class="infoflex">
             <span class="infodesign"><i class="fa fa-phone infoicondesign" aria-hidden="true"  style=""></i> 
          ...
          <a href="<?= base_url('website/sharecardview/'.$tempdata['id']); ?>" target="_blank" style="color: #fff;">Share</a>
            ...
            <!-- <div class="row justify-content-center">
		    	<div class="col-md-4 col-4">
		    	  <a href="https://api.whatsapp.com/send?text=<?= base_url('website/sharecardview/'.$tempdata['id']); ?>" target="_blank"> 
                  <i class="fab fa-whatsapp zoom"style="background:#ea1e63;padding: 10px;color: #fff;font-size: 30px;"></i> </a>	
		    	</div>
		    	<div class="col-md-4 col-4">
		          <a href="https://twitter.com/send?url=<?= base_url('website/sharecardview/'.$tempdata['id']); ?>" target="_blank" >
		    	       <i class="fab fa-twitter zoom" style="background:#ea1e63;padding: 10px;color: #fff;font-size: 30px;"></i> </a>
		    	</div>
		    	<div class="col-md-4 col-4">
		        	<a href="http://www.facebook.com/share.php?u=<?= base_url('website/sharecardview/'.$tempdata['id']); ?>" target="_blank" >
		        	       <i class="fab fa-facebook zoom"style="background:#ea1e63;padding: 10px;color: #fff;font-size: 30px;"></i>     </a>
		    	</div>
	 	    </div> -->
	   ...
	   <section class="produc youtubeflag" id="youtube">
		  <div class="container">
		    ...
		    <?php  
			 ...
			 if($social_links['d_yt_vid1'][0]  != null && $social_links['d_yt_vid1'][0] != '' ){ 
			 $youtubeflag = 1;
