...
$gallery_img  = json_decode($CardDatails['gallery_img'],true);
	...
	<section class="comp">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="compde">
						<form action="<?=  base_url('website/change_gallery') ?>" method="post" enctype="multipart/form-data">
              <div class="input_fields_wrap row mb-2">
                <input type="hidden" name="cardid" value="<?= $cardid; ?>">	
              <?php  
                if($gallery_img != null || $gallery_img != ''){  
               foreach ($gallery_img as $img) {    
               ?>
            <div class="col-md-4 mt-4">
            <!-- <label class="input_field_title">Your Images</label> -->
		        <center> <img src="<?= base_url($img); ?>" alt="Select image" id="showPreviewLogo1" class="zoom gell_img_size" onclick="clickFocus(1)" > </center>
					  <div class="input_box">  </div>
					  <input type="file" name="image[]" id="clickMeImage1" class="form-control mt-3" onchange="readURL1(this);" accept="image/*"  >
					      <input type="hidden" name="gelPrevImage[]"  value="<?= $img;  ?>" >
					  </div>
              <?php   }  } ?>     
							</div>
               <hr>
...
<script type="text/javascript">
  ...
  $(add_button).click(function(e){   //on add input button click
    ...
    if(x < max_fields){    //max input box allowed
         x++; 
    var imagetemplate = '<div class="col-md-4"> <center> <img src="<?= base_url('assets/website/images/img/upload.png'); ?>" alt="Select image" id="showPreviewLogo'+ x +'" class="zoom gell_img_size" onclick="clickFocus('+ x +')" width="50%" style="margin-bottom: 20px;margin-top: 20px;"></center><input type="hidden" name="gelPrevImage[]"><input type="file" name="image[]" id="clickMeImage'+ x +'" class="form-control" onchange="readURL'+ x +'(this);" accept="image/*"><hr><a href="#" class="remove_field">Remove</a></div>';
