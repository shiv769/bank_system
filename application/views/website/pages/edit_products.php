...
$all_products  = json_decode($CardDatails['all_products'],true);
//      echo "<pre>";
	...
	<section class="comp">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="compde">
						<form action="<?= base_url('website/change_all_products'); ?>" method="post" enctype="multipart/form-data">
							<div class="row">
                <div class="col-md-12">
                   <input type="hidden" name="cardid" value="<?= $cardid; ?>">	
                <div class="input_fields_wrap row mb-2">
              <?php    if($all_products != null || $all_products != ''){  
              	foreach ($all_products as  $product) {
             ?>
              <div class="col-md-4">
							<label class="input_field_title">Product Name</label>
							<input type="text" name="pro_name[]" maxlength="200" value="<?= $product['pro_name']; ?>" placeholder="Product/Service Name" class="form-control">
							<label class="input_field_title" >MRP Price</label>
							<input type="text" name="price[]" value="<?= $product['price']; ?>"   placeholder="MRP Price" class="form-control">
							<label class="input_field_title">Selling Price</label>
							<input type="text" name="discount[]" value="<?= $product['discount']; ?>"  placeholder="Selling Price" class="form-control">
            ...
            <?php }   }  ?>
               ...
               <button class="form-control btn btn-success" type="submit">Change</button>
						</form>	
					</div>
  				</div>	
			</div>
