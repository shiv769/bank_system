	...
	<noscript>
      ...
      <div class="vcard1">
       <center class="imagecenter"> 
          <img  src="<?= base_url($tempdata['c_logo']); ?>" style="width: 100px;border-radius: 50px;"> 
       </center>  
       
          <h3 style="margin-top: 75px;font-size: 25px;color: #9c28af;"> <?= $tempdata['c_name']; ?> </h3>
          ...
          <div class="infoflex">
             <span class="infodesign"><i class="fa fa-phone" aria-hidden="true" style="float: left;background-color: #ecd7ef;border-radius: 29px;padding: 15px;margin: -12px;"></i> 
             <small style="float: left;margin-left: 20px;"> +91-<?= $tempdata['mobile_no'];  ?>  </small>
            </span>
             <span class="infodesign"><i class="far fa-envelope" aria-hidden="true" style="float: left;background-color: #ecd7ef;border-radius: 29px;padding: 15px;margin: -12px;"></i> 
             <small style="float: left;margin-left: 20px;"> <?= $tempdata['email_id'];  ?> </small> 
            </span>
             <span class="infodesign"><i class="far fa-map" aria-hidden="true" style="float: left;background-color: #ecd7ef;border-radius: 29px;padding: 15px;margin: -12px;"> </i>
             <p style="float: left;margin: 0px 0px 0px 20px;"> <?= $tempdata['address']; ?> </p>    
            </span>
          </div>

        <div class="sharebutt">
          <a href="<?= base_url('website/sharecardview/'.$tempdata['id']); ?>" style="color: #fff;">Share</a>
        </div>   
