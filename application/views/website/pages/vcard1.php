...
// print_r($tempdata['phonepay_qr']);die;
?>
	...
	<center> <div > <span class="bg-light m-5">  <?=  $tempdata['tot_view']; ?> </span>  </div> </center>
      ...
      <div class="vcard1">
       <center class="imagecenter"> 
          ...
          <h3 style="margin-top: 70px;font-size: 18px;color: #000000;width: 250px;height:50px;"> <?= $tempdata['c_name']; ?> </h3>
        ...
        <div class="sharebutt">
            ...
            <!-- <div class="row justify-content-center">
		    	<div class="col-md-4 col-4">
                  ...
                  <i class="fab fa-whatsapp zoom"style="background:#000000;padding: 10px;color: #fff;font-size: 30px;"></i> </a>	
		    	</div>
		    	<div class="col-md-4 col-4">
		          <a href="https://twitter.com/send?url=<?= base_url('website/sharecardview/'.$tempdata['id']); ?>" target="_blank" >
		    	       <i class="fab fa-twitter zoom" style="background:#000000;padding: 10px;color: #fff;font-size: 30px;"></i> </a>
		    	</div>
		    	<div class="col-md-4 col-4">
		        	<a href="http://www.facebook.com/share.php?u=<?= base_url('website/sharecardview/'.$tempdata['id']); ?>" target="_blank" >
		        	       <i class="fab fa-facebook zoom"style="background:#000000;padding: 10px;color: #fff;font-size: 30px;"></i>     </a>
		    	</div>
		    </div> -->
