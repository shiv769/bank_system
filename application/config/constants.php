...
defined('PROJECT_NAME')        OR define('PROJECT_NAME','Bank System'); 
defined('OUR_BRAND')       	   OR define('OUR_BRAND',"Shivam Kumar.");
defined('SESSION_YEAR')        OR define('SESSION_YEAR',"$curyear");
defined('SITE_SALT')           OR define('SITE_SALT',"Bank_System");
defined('TP')        		   OR define('TP',"op_"); // Table Prefix
...
if(isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST']=='localhost'){
	...
	defined('DB_NAME')		? null : define('DB_NAME','db_bank_system');
}
else{
	defined('DB_HOST')      ? null : define('DB_HOST', 'localhost');
	defined('DB_USER')      ? null : define('DB_USER', 'db_bank_system');
	defined('DB_PASSWORD')  ? null : define('DB_PASSWORD', 'bank_system@9234#');
	defined('DB_NAME')      ? null : define('DB_NAME', 'db_bank_system');
}